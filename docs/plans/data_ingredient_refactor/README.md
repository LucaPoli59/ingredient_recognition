...
- [`controlled_vocabulary_evaluation.md`](controlled_vocabulary_evaluation.md) records the Yummly-specific Work package 2.2c experiment, findings, and decision gate that must be resolved before Work package 2.2d begins.
