...
OPTUNA_JOURNAL_TRASH_FILENAME = 'journal_trash.log'
OPTUNA_JOURNAL_PATH = os.path.join(EXPERIMENTS_PATH, OPTUNA_JOURNAL_FILENAME)
OPTUNA_JOURNAL_TRASH_PATH = os.path.join(EXPERIMENTS_PATH, OPTUNA_JOURNAL_TRASH_FILENAME)
DEF_N_TRIALS = 20
HTUNER_CONFIG_FILE = 'hparam_config.json'
HGEN_CONFIG_FILE = 'hparam_gen_config.json'
