...
if __name__ == "__main__":
    ...
    exp_name = "resnets_htuning_sel{10k}"
    metadata_filename = "sel_ing_2410_" + METADATA_FILENAME
    ...
    make_htuning_exp(exp_name, hgen_config, experiment_dir=exp_dir, max_epochs=max_epochs, debug=debug, lgn_model_type=BaseWithSchedulerLGNM,
                     torch_model_type=DummyModel, tr_type=OptunaTrainer, dm_category="all", dm_metadata_filename=metadata_filename,
                     tr_limit_train_batches=0.25,ht_n_trials=n_trials, ht_pruner=pruner, ht_pruner_kwargs=pruner_kwargs,
