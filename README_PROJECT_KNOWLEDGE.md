...
- Completare la fase Data residua definita in `docs/plans/data_ingredient_refactor/yummly_data_phase.md`: manifest e smoke test read-only degli anchor legacy 2.1c, quindi gli smoke test ML di training, checkpoint reload e dashboard richiesti dalla 2.4.
