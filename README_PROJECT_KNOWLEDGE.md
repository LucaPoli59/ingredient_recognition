...
**Stato della ricognizione:** architettura e flusso principale verificati nel codice; il dataset Yummly è stato analizzato integralmente su metadata e 65.146 immagini. Le regole esplicite e testate hanno prodotto il baseline riproducibile `ingredients_target_v4_metadata.json` (161 etichette, 60.354 ricette), ma non è selezionato per il runtime. La ricerca 2.2c è arrivata al checkpoint di discussione: propone FoodOn v2025-07-31 come riferimento semantico con concetti locali per i termini ambigui o scoperti e dimostra che la soglia 500 resta la causa principale della perdita di ingredienti validi. L'implementazione 2.2d attende l'approvazione del contratto.
